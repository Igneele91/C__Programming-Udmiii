// Version 5 mit zufalls zahlen und CPU stempel er geht eins runter im algoythmus beobachtung 


// nur spiel und stempel reinbringen 
// merken bei %s   = modulo string 

// Endfassung von Zeitstempel mit 
// random Ziel zahl  
...
int main()
{
    ...
    // alte version =( srand(time(NULL)); )  =   Zahlen generator 1 
    srand((unsigned int) time (NULL));  //       Zahlen generator 2 
