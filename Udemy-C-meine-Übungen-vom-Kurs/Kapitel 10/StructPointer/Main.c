...
struct Friend       // pointer variabel by call by referenz mit den Geburtstagen im Beispiel 
{
    char* name;
    char* prename;
    unsigned int year;
...
{
    f->name = new_name;     // call by referenz und einen Pfeil operator auf der linie 
}
