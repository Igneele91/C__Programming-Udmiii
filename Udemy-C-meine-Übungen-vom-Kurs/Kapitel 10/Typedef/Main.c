...
typedef     struct Friend          FR;          // typen defintion hier mit/   =  typedef struct Friend;
typedef float vector_3d[3];                     //  typdef float vector_3d[3]; = wir hier 3 Werte im array abgespeichert 
