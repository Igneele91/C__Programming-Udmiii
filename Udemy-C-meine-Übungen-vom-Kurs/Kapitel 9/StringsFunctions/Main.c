...
int main()
{
    ...
    char** friends;             // char** friends; anschauen mit dem string 
    ...
    // Dieses video ist so das es 3 Kombination namen also hat jemand den gleichen namen 
    // es ist mit vergleiche mit dem friend 1 und der friend3 odeer mit dem friend2 
    printf("same 01: %d\n", same_name_01);
    printf("same 02: %d\n", same_name_02);
    printf("same 12: %d\n", same_name_12);
